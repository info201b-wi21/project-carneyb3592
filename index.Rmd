...
The first five rows for `num_tweets_on_low_approval_dates_df` is shown below
```{r num_tweets_on_low_approval_dates_df,echo = FALSE}
library(knitr)
kable(head(num_tweets_on_low_approval_dates_df),n=5L)
```
...
The first five rows for `num_tweets_on_high_approval_dates_df` is shown below
```{r num_tweets_on_high_approval_dates_df,echo = FALSE}
library(knitr)
kable(head(num_tweets_on_high_approval_dates_df),n=5L)
```
